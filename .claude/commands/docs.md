---
description: Review and update rskit's documentation so it reads naturally and reflects the toolkit as it is today — keep Markdown paragraphs flowing without hard column wrapping, preserve intentional document structure, sync commands, crate/workspace structure, and examples with the actual code, fix stale links and dead references, drop history/plan narration, keep prose humanized and scannable with a task-first quickstart, and add mermaid diagrams where they clarify architecture or flow. Use when writing or auditing docs, repairing AI-generated hard wraps, after a change that makes documentation outdated, or before a release.
---
