...
description: >-
    ...
    fix stale links and dead references, and drop history/plan narration. Use when writing or auditing
    docs, repairing AI-generated hard wraps, after a change that outdated docs, or before a release.
user-invocable: true
---
