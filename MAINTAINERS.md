...
This file lists the people responsible for the rskit project. Maintainers are
...
rskit currently has a **single core maintainer**. This is a known
sustainability risk for a project of this size (40+ crates). We are actively
...
- A track record of high-quality contributions across multiple areas of the
  codebase.
- Familiarity with project conventions, the cargo workspace layout, the
  layering rules (enforced by `cargo-deny` / `cargo-machete`), and the
  release process.
