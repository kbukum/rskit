...
- **Split Cargo workspaces** — facade crate (`rskit`), foundation crates under `core/`, adapters under `contrib/`, and examples under `examples/`. There is no root `Cargo.toml`; use the Makefile or pass the correct `--manifest-path`.
