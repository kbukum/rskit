...
1. **Preferred**: [GitHub Security Advisories](https://github.com/kbukum/rskit/security/advisories/new) — opens a private disclosure thread visible only to maintainers.
...
- Releases are signed with [Sigstore](https://www.sigstore.dev/) (cosign) via the release workflow. SBOMs (CycloneDX, generated by `cargo-cyclonedx`) are attached to each release.
