...
//! and decoding structured text formats (TOML, JSON, YAML, …) through one canonical value model —
...
//! and the de-facto Rust interchange type, so TOML, JSON, and YAML all decode into it
