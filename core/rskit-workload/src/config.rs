...
//!
//! Mirrors gokit's `workload.Config` — the same shape across kits so a workload
//! app is structurally identical regardless of language.
...
pub struct WorkloadConfig {
    /// Whether the workload component is active. When `false`, the component
    /// starts as a healthy no-op and builds no backend.
    pub enabled: bool,
