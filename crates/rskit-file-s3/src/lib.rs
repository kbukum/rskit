...
//!
//! Implements the [`rskit_file::FileStore`] trait for Amazon S3 and any
...
//! - **Standard FileStore trait**: drop-in replacement for any rskit-file backend
//!
...
//!
//! ```rust,no_run
//! use rskit_file_s3::{S3Store, S3StoreConfig};
//!
