# rskit-file — File I/O & Storage

File I/O, storage backends, temp files, and MIME detection.

[![CI](https://github.com/kbukum/rskit/actions/workflows/ci.yml/badge.svg)](https://github.com/kbukum/rskit/actions/workflows/ci.yml)
[![crates.io](https://img.shields.io/crates/v/rskit-file.svg)](https://crates.io/crates/rskit-file)
[![docs.rs](https://docs.rs/rskit-file/badge.svg)](https://docs.rs/rskit-file)
...
```rust
use rskit_file::{FileSource, detect_kind, FileKind, TempFile};
