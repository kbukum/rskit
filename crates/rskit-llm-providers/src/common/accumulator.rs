...
use super::{StreamChunk, StreamToolCall};

pub(crate) fn merge_tool_delta(calls: &mut Vec<StreamToolCall>, delta: StreamToolCall) {
...
pub(crate) fn parse_input_json(input: &str) -> AppResult<Map<String, Value>> {
...
pub(crate) fn value_to_input_map(value: Value) -> AppResult<Map<String, Value>> {
    match value {
...
pub(crate) fn accumulate_tool_uses(
