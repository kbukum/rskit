# rskit-vector-store — Vector Similarity Search

Vector store abstractions with Qdrant and in-memory implementations.

[![CI](https://github.com/kbukum/rskit/actions/workflows/ci.yml/badge.svg)](https://github.com/kbukum/rskit/actions/workflows/ci.yml)
[![crates.io](https://img.shields.io/crates/v/rskit-vector-store.svg)](https://crates.io/crates/rskit-vector-store)
[![docs.rs](https://docs.rs/rskit-vector-store/badge.svg)](https://docs.rs/rskit-vector-store)
...
```toml
[dependencies]
rskit-vector-store = "0.1"
```

```rust
use rskit_vector_store::{VectorStore, InMemoryVectorStore, PointPayload};
